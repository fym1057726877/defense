...
from classifier.models import MSMDGANetCnn_wo_MaxPool
...
class TrainClassifier:
    def __init__(
        ...
        model_name = "PV_CNN_PV600"
        self.device = "cuda"
        self.classifier = MSMDGANetCnn_wo_MaxPool(num_classes=600).to(self.device)

        self.train_loader, self.test_loader = trainloader, testloader

        self.save_path = os.path.join(get_project_path("Defense"), "classifier", "PV_CNN", "PV600", f"{model_name}.pth")
