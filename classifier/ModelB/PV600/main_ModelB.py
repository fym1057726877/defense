...
class TrainClassifier:
    def __init__(
        ...
        model_name = "ModelB_PV600",
        self.device = "cuda"
        self.classifier = TargetedModelB(num_classes=num_classes).to(self.device)

        self.train_loader, self.test_loader = trainloader, testloader

        self.save_path = os.path.join(get_project_path("Defense"), "classifier", "ModelB", f"{model_name}.pth")
