...
from data.CASIA_PV200 import trainloader, testloader
...
class TrainClassifier:
    def __init__(
        ...
        classifier_name = "LightweightFVCNN"
        dataset_name = "PV200"
        model_name = f"{classifier_name}_{dataset_name}"
        num_classes = 200
        self.device = "cuda"
        self.classifier = LightweightDeepConvNN(num_classes=num_classes).to(self.device)
