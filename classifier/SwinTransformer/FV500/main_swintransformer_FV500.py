...
class TrainClassifier:
    def __init__(
        ...
        self.device = "cuda"
        model_name = "SwinTransformer_FV500"
        self.classifier = SwinTransformerV2(img_size=64, in_chans=1, num_classes=500, num_heads=[2, 4, 6, 8],
        ...
        self.save_path = os.path.join(get_project_path("Defense"), "classifier", "SwinTransformer", "FV500",
                                      f"{model_name}.pth")
