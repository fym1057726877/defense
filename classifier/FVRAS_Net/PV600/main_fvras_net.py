...
class TrainClassifier:
    def __init__(
        ...
        model_name = "FVRAS_Net_PV600"
        self.device = "cuda"
        self.classifier = FVRASNet_wo_Maxpooling(num_classes=600).to(self.device)

        self.train_loader, self.test_loader = trainloader, testloader

        self.save_path = os.path.join(get_project_path("Defense"), "classifier", "FVRAS_Net",
