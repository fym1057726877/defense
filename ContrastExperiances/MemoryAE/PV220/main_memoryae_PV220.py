...
class Trainer:
    def __init__(
        ...
        self.save_path = os.path.join(
            get_project_path(project_name="Defense"), "ContrastExperiances", "MemoryAE", "PV220", "memoryae_pv220.pth")
        ...
        # self.classifier_name = "Vit_PV220"
        # self.classifier_name = "Res2Net_PV220"

    def train(self, epochs, progress=True):
        start = time()
        best_acc = 0
        logging.basicConfig(filename="logs/memoryae_pv220_train.log", filemode="w", level=logging.INFO, format="")
    ...
    def test_defense(self):
        # classifier_name = "ModelB_PV220"
        # classifier_name = "Vit_PV220"
        # classifier_name = "Res2Net_PV220"
        # classifier_name = "SwinTransformer_PV220"

        # classifier_name = "FV_CNN_PV220"
        # classifier_name = "PV_CNN_PV220"
        classifier_name = "LightweightFVCNN_PV220"
        # classifier_name = "FVRAS_Net_PV220"
    ...
    def total_test(self):
        ...
        logging.basicConfig(filename="./logs/memoryae_test_pv220.log", filemode="w", level=logging.INFO, format="")
