...
class Trainer:
    def __init__(
        ...
        self.save_path = os.path.join(
            get_project_path(project_name="Defense"), "ContrastExperiances", "MemoryAE", "FV500", "memoryae_FV500.pth")
    ...
    def train(self, epochs, progress=True):
        start = time()
        best_acc = 0
        logging.basicConfig(filename="logs/memoryae_FV500_train.log", filemode="w", level=logging.INFO, format="")
        ...
        for epoch in range(epochs):
            ...
            with torch.no_grad():
                ...
                log = simple_test_defense(defense_model=self.model, attack_type="FGSM", eps=0.03, progress=False,
    ...
    def test_defense_one(self):
        ...
        log = simple_test_defense(defense_model=self.model, attack_type="FGSM", eps=0.1,
                                  testloader=self.testloader, iters=30,
        ...
        #                            testloader=self.testloader, iters=300,
    ...
    def BlackBoxAttackTest(self):
        ...
        for classifier_name in classifier_name_list:
            log1 = simple_test_defense(defense_model=self.model, attack_type="SPSA", eps=0.7,
