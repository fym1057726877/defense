...
class Trainer:
    def __init__(
        ...
        self.save_path = os.path.join(
            get_project_path(project_name="Defense"), "ContrastExperiances", "MemoryAE", "PV600", "memoryae.pth")
        ...
        self.classifier_name = "SwinTransformer_PV2200"

    def train(self, epochs, progress=True):
        start = time()
        best_acc = 0
        logging.basicConfig(filename="logs/memoryae_train.log", filemode="w", level=logging.INFO, format="")
    ...
    def total_test(self):
        ...
        logging.basicConfig(filename="PV600/logs/memoryae_test.logs", filemode="w", level=logging.INFO, format="")
