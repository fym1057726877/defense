...
class Trainer:
    def __init__(
        ...
        self.save_path = os.path.join(
            get_project_path(project_name="Defense"), "ContrastExperiances", "VQVAE_2", "FV500", "VQVAE_v2_FV500.pth")
    ...
    def train(self, epochs, progress=True):
        ...
        for epoch in range(epochs):
            ...
            with torch.no_grad():
                ...
                log = simple_test_defense(defense_model=self.model, attack_type="PGD", eps=0.03,
