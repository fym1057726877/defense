...
class TrainDiffusion:
    def __init__(
        ...
        self.save_path = os.path.join(
            get_project_path(project_name="Defense"), "pretrained", "MemoryUnet_for_LDM_use_VAE.pth")
    ...
    def test_ddim(self):
        ...
        z = self.autoencoder.encode(imgs).sample()
    ...
    def test_iter_denoise(self, t=50):
        ...
        imgs = imgs.to(self.device)
        z = self.autoencoder.encode(imgs).sample()
        final_z = iter_denoise(self.unet, imgs=z, t=t)
