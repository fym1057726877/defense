...
from utils import *
from LDM.aemodel.autoencoder import Autoencoder
...
class Trainer:
    def __init__(
        ...
        self.save_path = os.path.join(get_project_path(project_name="Defense"), "pretrained", "AutoEncoderforLDM.pth")
