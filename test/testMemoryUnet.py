...
from ours.diffusion.models import MemoryUnet
...
class DirectTrainActorReconstruct:
    ...
    def defense(self, img):
        rec = iter_denoise(self.unet, imgs=img, t=80, sampler="ddim", progress=False)
        return rec
...
if __name__ == "__main__":
    total_test(target_classifier_name="ModelB", defense_model_name="Memory_Unet_for_DM_t=80")
    # simple_test()
