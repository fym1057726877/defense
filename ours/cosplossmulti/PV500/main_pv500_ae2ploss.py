...
class Trainer:
    def __init__(
        ...
        self.save_path = os.path.join(
            get_project_path(project_name="Defense"), "ours", "cosplossmulti", "PV500", "memory_v2_pv500.pth")
    ...
    def train(self, epochs, progress=False):
        ...
        logging.basicConfig(filename="./log/memoryae_v2_ploss_train.logs", filemode="w", level=logging.INFO, format="")
        optimizer_ae = self.model.config_optimizer(lr=3e-4)
        best_acc = 0
